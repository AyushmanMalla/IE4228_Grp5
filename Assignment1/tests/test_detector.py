...
class TestHaarFaceDetectorInterface:
    """Verify HaarFaceDetector can be instantiated and has the right API."""

    def test_import(self):
        """HaarFaceDetector is importable from facerec_classical.detector."""
        from facerec_classical.detector import HaarFaceDetector
        assert HaarFaceDetector is not None
    ...
    def test_detection_dataclass_exists(self):
        ...
        det = Detection(bbox=(10, 20, 100, 150), area=15000)
        assert det.area == 15000
        assert det.bbox == (10, 20, 100, 150)

    def test_instantiation_default(self):
        """HaarFaceDetector can be created with default args."""
        from facerec_classical.detector import HaarFaceDetector
